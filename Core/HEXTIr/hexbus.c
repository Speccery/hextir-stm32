...
#ifdef STM32
	return HAL_GPIO_ReadPin(DB_BAV_GPIO_Port, DB_BAV_Pin);
#else
...
#ifdef STM32
	HAL_GPIO_WritePin(DB_BAV_GPIO_Port, DB_BAV_Pin, GPIO_PIN_SET);	// Pin in open drain mode.
#else
...
#ifdef STM32
	HAL_GPIO_WritePin(DB_BAV_GPIO_Port, DB_BAV_Pin, GPIO_PIN_RESET);	// Pin in open drain mode.
#else
...
#ifdef STM32
	HAL_GPIO_WritePin(DB_HSK_GPIO_Port, DB_HSK_Pin, GPIO_PIN_SET);	// Pin in open drain mode.
#else
...
#ifdef STM32
	HAL_GPIO_WritePin(DB_HSK_GPIO_Port, DB_HSK_Pin, GPIO_PIN_RESET);	// Pin in open drain mode.
	__asm("nop");
	__asm("nop");
	__asm("nop");
	__asm("nop");
...
#ifdef STM32
	return HAL_GPIO_ReadPin(DB_HSK_GPIO_Port, DB_HSK_Pin);
#else
...
#ifdef STM32
	HAL_GPIO_WritePin(DB_D0_GPIO_Port, DB_D0_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DB_D0_GPIO_Port, DB_D1_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DB_D0_GPIO_Port, DB_D2_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DB_D0_GPIO_Port, DB_D3_Pin, GPIO_PIN_SET);
#else
